...
namespace App.Services
{
    public class ValidacoesLista
    {
        ...
        public bool VerificarSeElementoExiste(List<int> lista, int numero)
        {
            return lista.Contains(numero);
        }

        public List<int> MultiplicarElementosDaLista(List<int> lista, int multiplicador)
        {
            return lista.Select(numero => numero * multiplicador).ToList();
        }
